"""
Django settings for ingredient_decoder project.
...
SECRET_KEY = 'django-insecure-u@f*y8h$yp6vp@zg^mm_d+$q5g-vged9li$i5@!ky+z00^-u+4'
...
ROOT_URLCONF = 'ingredient_decoder.urls'
